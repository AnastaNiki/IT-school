...
<head>
    ...
    <link rel="stylesheet" href="css/index_vitrina.css">
</head>
<body>
    ...
    <div class="container">
        <div class="header__inner">
            ...
            <a href="./index.php" class="logo">
                ...
                <svg class="logo-nam" width="134" height="30" viewBox="0 0 134 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <nav class="menu">
                ...
                <ul class="menu__list">
                    ...
                    <li class="menu__list-item">
                        <a class="menu__list-link link-main" href="index_vitrina.php">Стартапы</a>
                    </li>
                    <li class="menu__list-item">
...
<section  class="top">
    <div class="top__cont">
        <div class="top__image">
          <img class="top__image" src=".\startap_img\AllergOFF.png" width=352px height=352px alt="">
          <img id="butoom_left" src=".\startap_img\left_bottom.png"  alt=""></img>
        </img>
        </div>
        <div class="top__inner">
            ...
            <a class="butoom_right" onclick=""></a>
            <div class="create-choose-btn">
                <a href="create-choose.php" class="top__btn">Подробнее</a>
            </div>
            <div class="like_top">
                    <img src="./startap_img/like1.svg"></img> 412
                    <img src="./startap_img/reg1.svg"></img>  26
                    <img src="./startap_img/chel1.svg"></img>  58
            </div>
        </div>
    </div>
    <a id="but_center" onclick=""></a>
    <table class="h_vitrin">
    <tr>
      <td id="text_h_v">Популярные стартапы</td>
      <td id="filtr"></td>
    </tr>
    </table>
    <div class="vitrina">
        <table class="vitrina-blok" >
            <tr>
                <td clas="sartap-img" colspan="2" >
                  <img clas="sartap-img" src="./startap_img/akl.jpg" style="border-top-left-radius: 20px; border-top-right-radius: 20px; margin-left: 25px; margin-top: 26px;"></img>
                </td>
            </tr>
            <tr>
                <td class="inf_start" colspan="2">
                    <h1 class="inf_srart_h">«Акуня»</h1>
                    <p class="inf_srart_t">
            ...
            <tr >
                <td class="tip_start" style="background: #EF9E3E">
                Развлечения
                </td>
                <td class="like_start" style="background: #EF9E3E">
                    <img src="./startap_img/like.svg"></img> 120
                    <img src="./startap_img/rep.svg"></img> 13
                    <img src="./startap_img/chel.svg">  12
                </td>
            </tr>
        </table>
        <table class="vitrina-blok" >
            <tr>
                <td clas="sartap-img" colspan="2" >
                  <img clas="sartap-img" src="./startap_img/TechNo.png" style="border-top-left-radius: 20px; border-top-right-radius: 20px;"></img>
                </td>
            </tr>
            <tr>
                <td class="inf_start" colspan="2">
                    <h1 class="inf_srart_h">TechNo</h1>
                    <p class="inf_srart_t">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus magna
                    </p>
                </td>
            ...
            <tr >
                <td class="tip_start" style="background: #3D91F3">
                Технологии
                </td>
                <td class="like_start" style="background: #3D91F3">
                    <img src="./startap_img/like.svg"></img> 241
                    <img src="./startap_img/rep.svg"></img> 40
                    <img src="./startap_img/chel.svg">  82
                </td>
            </tr>
        </table>
        <table class="vitrina-blok" >
            <tr>
                <td clas="sartap-img" colspan="2" >
                  <img clas="sartap-img" src="./startap_img/TeaChya.png" style="border-top-left-radius: 20px; border-top-right-radius: 20px;"></img>
                </td>
            </tr>
            <tr>
                <td class="inf_start" colspan="2">
                    <h1 class="inf_srart_h">TeaChya</h1>
                    <p class="inf_srart_t">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus magna
                    </p>
                </td>
            ...
            <tr >
                <td class="tip_start" style="background: #304F73">
                Образование
                </td>
                <td class="like_start" style="background: #304F73">
                    <img src="./startap_img/like.svg"></img> 86
                    <img src="./startap_img/rep.svg"></img> 9
                    <img src="./startap_img/chel.svg">  6
                </td>
            </tr>
        </table>
        <table class="vitrina-blok" style="margin-right: 0px">
            <tr>
                <td clas="sartap-img" colspan="2" >
                  <img clas="sartap-img" src="./startap_img/БинОк.png" style="border-top-left-radius: 20px; border-top-right-radius: 20px;"></img>
                </td>
            </tr>
            <tr>
                <td class="inf_start" colspan="2">
                    <h1 class="inf_srart_h">БинОк</h1>
                    <p class="inf_srart_t">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus magna
                    </p>
                </td>
            ...
            <tr >
                <td class="tip_start" style="background: #8FB838">
                Экология
                </td>
                <td class="like_start" style="background: #8FB838">
                    <img src="./startap_img/like.svg"></img> 542
                    <img src="./startap_img/rep.svg"></img> 124
                    <img src="./startap_img/chel.svg">  321
                </td>
            </tr>
        </table>
...
<div id="reg" class="form" onclick="first_3()">
    ...
    <div></div>
        ...
        <div class="pass">
            <input id="submit-btn" type="submit" value="Зарегистрироваться" name="Зарегистрироваться">
...
<div id="vhod" class="form" onclick="first_3()">
    ...
    <div>
        ...
        <div class="pass">
            <input id="submit-btn" type="submit" value="Войти"name="Войти">
